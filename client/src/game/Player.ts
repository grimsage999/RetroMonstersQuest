...
export class Player {
  ...
  private getIdleFrame() {
    // Cosmo kawaii cosmic design (16x16) - inspired by moodboard cute aliens
    return [
      ...
      [2,2,2,4,4,2,2,2,2,4,4,2,2,2,0,0], // Row 3 - big kawaii eyes
      [2,2,4,1,1,4,2,2,4,1,1,4,2,2,0,0], // Row 4 - eye shine highlights
      [2,2,2,4,4,2,2,2,2,4,4,2,2,2,0,0], // Row 5 - eyes
      [2,2,2,2,2,2,6,6,2,2,2,2,2,2,0,0], // Row 6 - cute nose (pink)
      [2,2,2,6,2,2,2,2,2,2,6,2,2,2,0,0], // Row 7 - small blush marks
      [0,2,2,2,2,2,2,2,2,2,2,2,2,0,0,0], // Row 8 - face
      [0,0,0,5,5,5,7,7,5,5,5,0,0,0,0,0], // Row 9 - body with cosmic details
      [0,0,5,5,7,5,5,5,5,7,5,5,0,0,0,0], // Row 10 - body with stars
