...
const OAUTH_CLIENT_ID =
  process.env.GOOGLE_OAUTH_CLIENT_ID || 'your-oauth-client-id.apps.googleusercontent.com';
...
const OAUTH_CLIENT_SECRET = process.env.GOOGLE_OAUTH_CLIENT_SECRET || 'your-oauth-client-secret';
